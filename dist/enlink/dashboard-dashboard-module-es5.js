  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    function A17u(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(CandidateDashboardComponent, [{
          ...
          value: function getSPVotes() {
            ...
            this.http.getSPVotes().subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                _this.spDataList = res === null || res === void 0 ? void 0 : res.data;
                _this.api_call_loader['cardLoader3'] = false;
              } else {
                _this.api_call_loader['cardLoader3'] = false;
              }
            });
          ...
          value: function getDistrictWiseData(type) {
            ...
            this.http.getDistrictWiseData().subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                ...
                _this2.candidateLists[0]['dataList'] = res === null || res === void 0 ? void 0 : res.data;

                if (type == 'District') {
                  _this2.api_call_Loader['listDistrict'] = false;
                } else {
                  _this2.candidateLists[0]['api_call_loader'] = false;
                }
              } else {
                if (type == 'District') {
                  _this2.api_call_Loader['listDistrict'] = false;
          ...
          value: function getAssemblyData(type) {
            ...
            this.http.getAssemblyDashboard(data).subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                _this3.candidateLists[1]['dataList'] = res === null || res === void 0 ? void 0 : res.data;

                if (type == 'Assembly') {
                  _this3.api_call_Loader['listAssembly'] = false;
                } else {
                  _this3.candidateLists[1]['api_call_loader'] = false;
                }
              } else {
                if (type == 'Assembly') {
                  _this3.api_call_Loader['listAssembly'] = false;
          ...
          value: function getGSCandidate(type) {
            ...
            this.http.getGSCandidateData().subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                _this4.gsDataList = res === null || res === void 0 ? void 0 : res.data;

                if (type !== 'tableLoader') {
                  _this4.api_call_Loader['card'] = false;
                } else {
                  _this4.api_call_Loader['listGS'] = false;
                }
              } else {
                if (type !== 'tableLoader') {
                  _this4.api_call_Loader['card'] = false;
      ...
      CandidateDashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        pipes: [ng2_search_filter__WEBPACK_IMPORTED_MODULE_14__["Ng2SearchPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_12__["DecimalPipe"]],
    ...
    function QX6l(module, __webpack_exports__, __webpack_require__) {
      ...
      var ng_zorro_antd_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ng-zorro-antd/list */
      "Ff2k");
      /* harmony import */


      var ng_zorro_antd_pagination__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      function DashboardComponent_nz_list_item_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardComponent_nz_list_item_16_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_nz_list_item_16_Template_span_click_21_listener() {
            ...
            return ctx_r11.openFacebook(item_r10.post_url);
          });
      ...
      var DashboardComponent = /*#__PURE__*/function () {
        ...
        _createClass(DashboardComponent, [{
          ...
          value: function ngOnInit() {
            this.loadData(1);
            this.getPostList();
            this.getFollowerList(); // this.getBackgroundDataAPIFunction(params_data, "LATEST_POST_API_URL")
            ...
            this.http.getDataFromBackgroundFunction(params_data).subscribe(function (res) {
              if (res['data']) {
                if (section == "LATEST_POST_API_URL") {
                  _this5.LatestPostDataSet = res['data'];
                  console.log(_this5.LatestPostDataSet);
                } else {
                  _this5.StrongFollowersList = res['data'];
                }
          ...
          value: function getPostList(tableFilter, type) {
            ...
            var params_data = {
              "link": "https://www.facebook.com/dyadav.bhilai.official",
            ...
            this.http.getDataFromBackgroundFunction(params_data).subscribe(function (res) {
              if (res['data']) {
                _this6.LatestPostDataSet = res['data'];
                console.log("latest Post", _this6.LatestPostDataSet);
                _this6.api_loader['postList'] = false;
              } else {
                _this6.api_loader['postList'] = false;
              }
            });
          ...
          value: function getFollowerList(tableFilter, type) {
            ...
            this.http.getDataFromBackgroundFunction(params_data).subscribe(function (res) {
              if (res['data']) {
                _this7.StrongFollowersList = res['data'];
                console.log("StrongFollowersList", _this7.StrongFollowersList);
                _this7.api_loader['followerList'] = false;
              } else {
                _this7.api_loader['followerList'] = false;
              }
            });
      ...
      DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 20,
        vars: 11,
        consts: [[1, "row"], [1, "col-md-6"], ["class", "col-md-6", 4, "ngFor", "ngForOf"], [1, "col-md-12", "h-100"], ["nzTitle", "Strong Followers", 2, "height", "25rem", "overflow", "scroll", 3, "nzLoading", "nzExtra"], ["nzItemLayout", "vertical"], [4, "ngFor", "ngForOf"], [3, "nzPageIndex", "nzTotal", "nzPageIndexChange", "nzPageSizeChange"], ["extraTemplate", ""], [1, "col-md-6", "h-100"], ["nzTitle", "Latest Posts", 2, "height", "100vh", "overflow", "scroll", 3, "nzLoading", "nzExtra"], [1, "-flex", "align-items-center", "pointer"], [1, "media", "align-items-center"], [3, "nzSize", "nzIcon", "ngClass"], [1, "m-l-15"], [1, "m-b-0"], [1, "m-b-0", "text-dark"], ["alt", "", 3, "nzSrc"], [3, "nzSrc"], [1, "d-flex", "justify-content-start"], [3, "href"], [1, "ml-3"], ["nz-list-item-actions", ""], ["nz-icon", "", "nzType", "like", 2, "margin-right", "8px"], ["nz-icon", "", "nzType", "comment", 2, "margin-right", "8px"], ["nz-icon", "", "nzType", "share-alt", 2, "margin-right", "8px"], [1, "text-secondary", 3, "routerLink", "queryParams"], ["nz-icon", "", "nzType", "facebook", 2, "margin-right", "8px", 3, "click"], [1, "d-flex", "flex-column"], ["alt", "logo", 1, "post_image_style", 2, "width", "100px", "height", "80px", 3, "src"]],
        template: function DashboardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("nzPageIndexChange", function DashboardComponent_Template_nz_pagination_nzPageIndexChange_10_listener($event) {
              return ctx.getFollowerList($event, "pageIndex");
            })("nzPageSizeChange", function DashboardComponent_Template_nz_pagination_nzPageSizeChange_10_listener($event) {
              return ctx.getFollowerList($event, "");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("nzPageIndexChange", function DashboardComponent_Template_nz_pagination_nzPageIndexChange_19_listener($event) {
              return ctx.getPostList($event, "pageIndex");
            })("nzPageSizeChange", function DashboardComponent_Template_nz_pagination_nzPageSizeChange_19_listener($event) {
    ...
    function TDBs(module, __webpack_exports__, __webpack_require__) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DashboardModule, {
          declarations: [_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], _candidate_dashboard_candidate_dashboard_component__WEBPACK_IMPORTED_MODULE_21__["CandidateDashboardComponent"]],
