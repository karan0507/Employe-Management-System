...
export class AddLeaderTaskComponent implements OnInit {
  ...
  createTask(data?) {
    this.taskForm = this.fb.group({
      ...
      start_date: [data?.task_end_date ? data?.task_end_date : '', [Validators.required]],
  ...
  submitForm() {
    ...
    // url.
    this.http.addLeaderTasks(form_data).subscribe((res: any) => {
      if (res.success) {
