(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~voter-voter-module"], {
    /***/
    "ZyQt":
    /*!*******************************************************************************!*\
          ...
          value: function alignToElement(element) {
            ...
            this.ngZone.runOutsideAngular(function () {
              Object(ng_zorro_antd_core_polyfill__WEBPACK_IMPORTED_MODULE_2__["reqAnimFrame"])(function () {
                return _this2.setStyles(element);
              });
            });
          }
        }, {
        ...
        _createClass(NzTabNavBarComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            var realign = function realign() {
              _this4.updateScrollListPosition();

              _this4.alignInkBarToSelectedTab();
            };
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["merge"])(dirChange, resize, this.items.changes).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.destroy$)).subscribe(function () {
              ...
              _this4.keyManager.withHorizontalOrientation(_this4.getLayoutDirection());
            });
            this.keyManager.change.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.destroy$)).subscribe(function (newFocusIndex) {
              _this4.indexFocused.emit(newFocusIndex);

              _this4.setTabFocus(newFocusIndex);

              _this4.scrollToTab(_this4.keyManager.activeItem);
            });
          }
        }, {
          ...
          value: function lockAnimation() {
            ...
            if (this.lockAnimationTimeoutId === -1) {
              this.ngZone.runOutsideAngular(function () {
                _this6.navListRef.nativeElement.style.transition = 'none';
                _this6.lockAnimationTimeoutId = setTimeout(function () {
                  _this6.navListRef.nativeElement.style.transition = '';
                  _this6.lockAnimationTimeoutId = -1;
                }, CSS_TRANSFORM_TIME);
              });
            }
          }
      ...
      var NzTabScrollListDirective = /*#__PURE__*/function () {
        function NzTabScrollListDirective(ngZone, elementRef) {
          ...
          this.onTouchEnd = function (e) {
            if (!_this7.touchPosition) {
              return;
            }

            var lastOffset = _this7.lastOffset;
            var lastTimeDiff = _this7.lastTimeDiff;
            _this7.lastOffset = _this7.touchPosition = null;
            ...
            if (lastOffset) {
              ...
              _this7.motion = window.setInterval(function () {
                if (Math.abs(currentX) < STOP_SWIPE_DISTANCE && Math.abs(currentY) < STOP_SWIPE_DISTANCE) {
                  window.clearInterval(_this7.motion);
                  return;
                }
                ...
                _this7.onOffset(currentX * REFRESH_INTERVAL, currentY * REFRESH_INTERVAL, e);
              }, REFRESH_INTERVAL);
            }
          };
          ...
          this.onTouchMove = function (e) {
            ...
            var offsetX = screenX - _this7.touchPosition.x;
            var offsetY = screenY - _this7.touchPosition.y;

            _this7.onOffset(offsetX, offsetY, e);

            var now = Date.now();
            _this7.lastTimeDiff = now - _this7.lastTimestamp;
            _this7.lastTimestamp = now;
            _this7.lastOffset = {
              x: offsetX,
              y: offsetY
            };
            _this7.touchPosition = {
              x: screenX,
              y: screenY
            };
          };
          ...
          this.onWheel = function (e) {
            ...
            if (absX === absY) {
              mixed = _this7.lastWheelDirection === 'x' ? deltaX : deltaY;
            } else if (absX > absY) {
              mixed = deltaX;
              _this7.lastWheelDirection = 'x';
            } else {
              mixed = deltaY;
              _this7.lastWheelDirection = 'y';
            ...
            if (now - _this7.lastWheelTimestamp > 100 || absMixed - _this7.lastMixedWheel > 10) {
              _this7.lastWheelPrevent = false;
            }

            _this7.onOffset(-mixed, -mixed, e);

            if (e.defaultPrevented || _this7.lastWheelPrevent) {
              _this7.lastWheelPrevent = true;
            }

            _this7.lastWheelTimestamp = now;
            _this7.lastMixedWheel = absMixed;
          };
        }
        ...
        _createClass(NzTabScrollListDirective, [{
          ...
          value: function ngOnInit() {
            ...
            this.unsubscribe = this.ngZone.runOutsideAngular(function () {
              var el = _this8.elementRef.nativeElement;
              ...
              subscription.add(_this8.subscribeWrap('wheel', wheel$, _this8.onWheel));
              subscription.add(_this8.subscribeWrap('touchstart', touchstart$, _this8.onTouchStart));
              subscription.add(_this8.subscribeWrap('touchmove', touchmove$, _this8.onTouchMove));
              subscription.add(_this8.subscribeWrap('touchend', touchend$, _this8.onTouchEnd));
              return function () {
        ...
        _createClass(NzTabSetComponent, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this.tabsSubscription = this.tabs.changes.subscribe(function () {
              var indexToSelect = _this12.clampTabIndex(_this12.indexToSelect); // Maintain the previously-selected tab if a new tab is added or removed and there is no
              // explicit change that selects a different tab.


              if (indexToSelect === _this12.selectedIndex) {
                var tabs = _this12.tabs.toArray();
                ...
                for (var i = 0; i < tabs.length; i++) {
                  if (tabs[i].isActive) {
                    ...
                    _this12.indexToSelect = _this12.selectedIndex = i;
                    break;
                  }
                }
              }

              _this12.subscribeToTabLabels();
          ...
          value: function ngAfterContentChecked() {
            ...
            if (this.selectedIndex !== indexToSelect) {
              ...
              Promise.resolve().then(function () {
                _this13.tabs.forEach(function (tab, index) {
                  return tab.isActive = index === indexToSelect;
                });

                if (!isFirstRun) {
                  _this13.nzSelectedIndexChange.emit(indexToSelect);
                }
              });
            ...
            this.tabs.forEach(function (tab, index) {
              ...
              if (_this13.selectedIndex != null && tab.position === 0 && !tab.origin) {
                tab.origin = indexToSelect - _this13.selectedIndex;
              }
            });
          ...
          value: function subscribeToAllTabChanges() {
            ...
            this.allTabs.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["startWith"])(this.allTabs)).subscribe(function (tabs) {
              _this15.tabs.reset(tabs.filter(function (tab) {
                return tab.closestTabSet === _this15;
              }));

              _this15.tabs.notifyOnChanges();
            });
          }
        }, {
          ...
          value: function setSelectedIndex(index) {
            ...
            this.canDeactivateSubscription = this.canDeactivateFun(this.selectedIndex, index).subscribe(function (can) {
              if (can) {
                _this16.nzSelectedIndex = index;
                _this16.tabNavBarRef.focusIndex = index;
          ...
          value: function isLinkActive(router) {
            ...
            return function (link) {
              return link ? router.isActive(link.urlTree, _this18.nzLinkExact) : false;
            };
          }
        }, {
...
//# sourceMappingURL=default~home-home-module~voter-voter-module-es5.js.map