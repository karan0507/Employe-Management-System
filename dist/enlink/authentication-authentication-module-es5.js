      ...
      var Login1Component = /*#__PURE__*/function () {
        ...
        _createClass(Login1Component, [{
          ...
          value: function ngOnInit() {
            ...
            var url = "admin.chatiyc.com";
            this.subDomainName = url.split('.');
            console.log(this.subDomainName[0]);
            this.getSubDomain(this.subDomainName[0]); // console.log(this.active_route.snapshot.firstChild.url[0].path);
          ...
          key: "getSubDomain",
          value: function getSubDomain(sub) {
            var _this11 = this;

            // let data = {'account_code' : sub}; 
            var data = {
              'account_code': 'shksufiyan'
            };
            this.HttpService.getSubDomainData(data).subscribe(function (res) {
              if (res.success) {} else {
                _this11.router.navigateByUrl('error');
              }
            });
          }
        }, {
          ...
          value: function sendOTPAPIFunction(form) {
            ...
            this.HttpService.UserLoginSendOTP(data, end_point).subscribe(function (res) {
              _this12.setTimerFromStart();

              _this12._apiCallLoader['loginloader'] = false;

              if (res.success) {
                _this12.message.success(res.message);

                _this12._currentSection = 'OTPVerification';
              }
            }, function (err) {
              _this12._apiCallLoader['loginloader'] = false;
            });
          ...
          value: function VerifyUserFunction() {
            ...
            this.HttpService.verifyUserAPI(end_point).subscribe(function (res) {
              if (res.success) {
                _this13.globalFunction.sendUserData(res);

                console.log('In checkusr log');
                localStorage.setItem("iyc_user_data", JSON.stringify(res.data));

                _this13.checkUserLoggedInOrNot(res);
              }
            }, function (err) {
              _this13.router.navigate(["/authentication/login"]);
            ...
            if (localStorage.getItem('iyc_user_token')) {
              ...
              if (localStorage.getItem('iyc_user_data')) {
                ...
                if (((_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.user_type) === null || _b === void 0 ? void 0 : _b.name) == 'Superuser') {
                  ...
                  setTimeout(function () {
                    _this14.ifTokenAuthorized = false;

                    _this14.router.navigate(["/voter"]);
                  }, 6000);
          ...
          value: function verifyOTPFunction(form) {
            ...
            this.HttpService.verifyOTPAPI(data, end_point).subscribe(function (res) {
              _this15._apiCallLoader["verifyOTP"] = false;
              ...
              if (res.success) {
                ...
                setTimeout(function () {
                  ...
                  _this15.permissionsService.loadPermissions(permissions);

                  if (((_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.user_type) === null || _b === void 0 ? void 0 : _b.name) == 'Superuser') {
                    _this15.router.navigate(["/voter"]); // this.router.navigate(["/dashboard/home"]);

                  } else if (((_d = (_c = res.data) === null || _c === void 0 ? void 0 : _c.user_type) === null || _d === void 0 ? void 0 : _d.name) == 'Data Operator' || ((_f = (_e = res.data) === null || _e === void 0 ? void 0 : _e.user_type) === null || _f === void 0 ? void 0 : _f.name) == 'Supervisor') {
                    _this15.router.navigate(["/data-operator/home"]);
                  } else if (((_h = (_g = res.data) === null || _g === void 0 ? void 0 : _g.user_type) === null || _h === void 0 ? void 0 : _h.name) == 'Account Manager') {
                    _this15.router.navigate(["/accounts/vouchers"]);
                  }
                }, 0);
              }
            }, function (err) {
          ...
          value: function setTimerFromStart() {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(this.count_value), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function () {
              return --_this16.count_value;
            })).subscribe(function (value) {
              _this16.realCountertimer = value;
            });
          }
        }, {
