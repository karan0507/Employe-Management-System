(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function Tr7(module, __webpack_exports__, __webpack_require__) {
      ...
      var _babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    ...
    function EQFL(module, __webpack_exports__, __webpack_require__) {
      ...
      ViewProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 7,
        vars: 2,
        consts: [[1, "row"], [1, "col-md-12"], [1, "d-flex", "justify-content-center", "mb-3"], ["nzIcon", "user", 1, "profile-img", 3, "nzSrc"], ["class", "col-md-12 my-3", 4, "ngFor", "ngForOf"], [1, "col-md-12", "my-3"], [1, "d-flex", "justify-content-between", "align-items-center", "w-100"], [1, "d-flex", "flex-column"], [1, "d-flex", "align-items-center"], ["alt", "", 1, "=", 3, "src"], [1, "mr-3", "mb-0", "ml-1"], [1, "my-2"]],
        ...
        directives: [ng_zorro_antd_avatar__WEBPACK_IMPORTED_MODULE_1__["NzAvatarComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], ng_zorro_antd_divider__WEBPACK_IMPORTED_MODULE_3__["NzDividerComponent"]],
    ...
    function q0hq(module, __webpack_exports__, __webpack_require__) {
      ...
      function UserProfileComponent_ng_container_24_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function UserProfileComponent_ng_container_24_Template_nz_select_ngModelChange_4_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

            var ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r1._currLanguage = $event;
          });
          ...
          value: function handleOk() {
            ...
            this.http.changeLanguage(data).subscribe(function (res) {
              if (res.success) {
                ...
                _this3.router.navigateByUrl("/authentication/login");
              } else {
      ...
      UserProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 25,
        vars: 5,
        consts: [[1, "row", "mt-3"], [1, "col-md-12", "mb-3"], [1, "shadow-sm", "border"], ["routerLink", "/profile/view-profile", 1, "d-flex", "justify-content-between", "align-items-center", "py-2"], [1, "d-flex"], ["nzIcon", "user", "width", "50", "height", "50", "src", "../.././../assets/images/avatars/dy_post_image.jpg", 1, "mr-3", "rounded-circle"], [1, "d-flex", "flex-column"], ["for", ""], ["nz-icon", "", "nzType", "right", "nzTheme", "outline", 1, "font-size-22", "font-weight-semibold", "text-dark"], [1, "col-md-12", "my-3"], [1, "d-flex", "flex-wrap", "justify-content-between", "align-items-center"], [1, "d-flex", "align-items-center", 3, "click"], ["nz-icon", "", "nzTheme", "outline", 1, "mr-3", "font-size-20", "iconBg", 3, "nzType"], [1, "text-dark", "font-size-16"], ["nz-icon", "", "nzType", "right", "nzTheme", "outline", 1, "font-size-18", "font-weight-bold", "text-dark"], [1, "mb-3", "px-5", "text-muted"], [1, "mb-2", 3, "nzOrientation"], ["nzTitle", "Change Language", 3, "nzVisible", "nzVisibleChange", "nzOnCancel", "nzOnOk"], [4, "nzModalContent"], [1, "d-flex", "align-items-center"], [1, "mr-3"], ["nzShowSearch", "", 1, "selectFilter", "mb-2", "mr-3", 3, "ngModel", "nzPlaceHolder", "ngModelChange"], [3, "nzValue", "nzLabel"]],
        template: function UserProfileComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserProfileComponent_Template_div_click_16_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("nzVisibleChange", function UserProfileComponent_Template_nz_modal_nzVisibleChange_23_listener($event) {
              return ctx.isChangeLanguage = $event;
            })("nzOnCancel", function UserProfileComponent_Template_nz_modal_nzOnCancel_23_listener() {
              return ctx.isChangeLanguage = false;
            })("nzOnOk", function UserProfileComponent_Template_nz_modal_nzOnOk_23_listener() {
              return ctx.handleOk();
            });
